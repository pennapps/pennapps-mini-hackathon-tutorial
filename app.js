...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  (0, _jquery2.default)('#game').on('mousedown', function (e) {
	    anchorX = e.offsetX;
	    anchorY = e.offsetY;
	    (0, _jquery2.default)(this).on('mousemove', function (move) {
	      mouseX = move.offsetX;
	      mouseY = move.offsetY;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.birdConfig = exports.createBird = undefined;
	...
	var createBird = function createBird(type, x, y) {
	  var canSplit = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3];
	  ...
	  if (!window.world) {
	    ...
	    return window.world.createEntity(birdConfig, {
	      ...
	      onImpact: function onImpact(entity, normal, tangential) {
	        if (normal > 5) {
	          (0, _helpers.timerHelper)("start", window, this, TIMEOUT_CONST);
	        }
	        if (normal > BIRD_TYPES[type]['force']) {
	          (0, _helpers.timerHelper)("reset", window, this, TIMEOUT_CONST);
	          this.$hits++;
	        }
	        if (this.$hits > 3) {
	          this.destroy();
...
/***/ function(module, exports) {
	...
	exports.groundConfig = groundConfig;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.blockConfig = exports.createBlock = undefined;
	...
	var createBlock = function createBlock(x, y, width, height, type) {
	  var gravity = arguments.length <= 5 || arguments[5] === undefined ? true : arguments[5];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.pigConfig = pigConfig;
	exports.createPig = createPig;
